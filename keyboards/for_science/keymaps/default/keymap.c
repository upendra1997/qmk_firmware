...
[_DVORAK] = LAYOUT_split_4x5_3(
    KC_TAB,   KC_ESC,  KC_LPRN, KC_UNDS, KC_MINS,    KC_BSPC, KC_SLSH, KC_RPRN, KC_EQL,  KC_PLUS,
...
[_LAYER] = LAYOUT_split_4x5_3(
    KC_GRV,  KC_GRV,  KC_LABK, KC_LCBR, KC_LBRC,    KC_DEL,  KC_BSLS, KC_RABK, KC_RCBR, KC_RBRC,
